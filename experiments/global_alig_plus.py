...
class GlobalAligPlus(torch.optim.Optimizer):
    r"""
    ...
    def __init__(self, params, lr, data_size, epochs, weight_decay=0.0, momentum=0.9, K=5):
        ...
        self.aovs = torch.zeros(1, device=p.device) # AOVs
        self.aov_minus_last = torch.zeros(1, device=p.device) #  = A0V_{k} - AOV_{k-1}
