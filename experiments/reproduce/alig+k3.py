...
def create_jobs():
    ...
    template = "python main.py --no_tb --no_visdom --batch_size 128 --epochs 200 --depth 10 --K 3 "
    ...
    template = "python main.py --no_tb --no_visdom --batch_size 128 --epochs 200 --depth 10 --K 3 "
    no_data_aug = " --no_data_augmentation --tag nda_3k"
    data_aug = " --tag da"
...
def list_jobs(template, jobs):
    ...
    with open("reproduce/alig_plus.yaml", "r") as f:
